  ...
  return (
    <Pressable
      style={({ pressed }) => [
        ...
        isLoading && isPlaying && styles.disabled
      ]}
    ...
    >
      ...
      >
        ...
        <View style={styles.versetsContainer}>
          <MaterialCommunityIcons name="book-open-page-variant" size={20} color={secondary} />
...
const styles = StyleSheet.create({
  ...
  arabicTitle: {
    fontSize: 20,
    color: secondary,
    fontFamily: 'System', // Vous pouvez utiliser une police arabe spécifique ici
    textAlign: 'left',
  },
  versetsContainer: {
    flexDirection: 'row',
